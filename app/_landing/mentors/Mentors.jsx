...
import { Video, Clock, AlertCircle, Mail } from "lucide-react";
        ...
        <div className="mt-10 rounded-3xl border border-gray-200 bg-white overflow-hidden">
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-wrap gap-3 mb-5">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-sm font-medium" style={{ borderColor: "#1FD14A33", color: "#16a34a", background: "#f0fdf4" }}>Wise</span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-sm font-medium" style={{ borderColor: "#00308733", color: "#003087", background: "#eff6ff" }}>PayPal</span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-sm font-medium" style={{ borderColor: "#e2136e44", color: "#e2136e", background: "#fdf2f8" }}>bKash</span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-300 text-sm text-gray-600 bg-gray-50">Bank Transfer</span>
            </div>
