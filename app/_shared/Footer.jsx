...
import { FaFacebook, FaTwitter, FaYoutube, FaInstagram, FaLinkedin, FaTelegram, FaWhatsapp } from 'react-icons/fa';
...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: MdEmail, text: 'mentors.career.abroad26@gmail.com', href: 'mailto:mentors.career.abroad26@gmail.com' },
  ];

  const socialLinks = [
    { name: 'Facebook', icon: FaFacebook, href: 'https://www.facebook.com/AhsanSunyOfficial' },
    { name: 'Youtube', icon: FaYoutube, href: 'https://www.youtube.com/@AhsanSuny' },
    { name: 'Telegram', icon: FaTelegram, href: 'https://t.me/+XqNJTqNTww04YTRk' },
    { name: 'Whatsapp', icon: FaWhatsapp, href: 'https://chat.whatsapp.com/Lcbi3XgUSko1HEoBpgoKor?mode=ems_copy_t' }
  ];
